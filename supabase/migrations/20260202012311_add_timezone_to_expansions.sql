-- Add timezone column to expansions table (where raid schedule fields are stored)
ALTER TABLE expansions
ADD COLUMN IF NOT EXISTS timezone TEXT DEFAULT 'America/New_York';

-- Drop and recreate get_guild_expansions RPC to return timezone (must drop first to change return type)
