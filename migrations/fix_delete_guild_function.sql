-- Fix delete_guild function to also clean up character-based membership data
-- The original function only deleted from guild_members (old system)
-- but not character_guild_memberships (new system)
