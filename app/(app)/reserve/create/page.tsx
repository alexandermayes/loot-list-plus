...
// Expansions that have loot data
...
export default function CreateReserveRunPage() {
  ...
  // Guild-linked mode: use guild's active expansion by default
  const isGuildMode = !!activeGuild && isOfficer

  useEffect(() => {
    document.title = 'LootList+ \u2022 Create Reserve Run'
  }, [])
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      // If guild mode, use guild's expansion data
      ...
      // Quick run mode: fetch tiers via public API
  ...
  const selectedExpVisuals = selectedExpansion ? getExpansionVisuals(selectedExpansion) : null

  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto">
      <div className="mb-6">
        <Heading level={1}>Create reserve run</Heading>
          ...
          <>
            ...
            <div className="flex items-center gap-3 pt-4 border-t border-border">
              ...
              <Button
                ...
                loading={submitting}
                disabled={!selectedTierId || !title.trim() || !raidAt || !lockAt}
              >
                Create run
              </Button>
            </div>
