  ...
  return (
    <section id="cta" className="relative pt-16 md:pt-24 pb-32 md:pb-40 bg-[#080808]">
      <div className="absolute inset-0 max-w-[1440px] mx-auto">
        ...
        >
          <Image src="/images/landing/items/tusks-of-mannoroth.webp" alt="" fill sizes="600px" className="object-contain" />
        </ParallaxItem>
        ...
        >
          <Image src="/images/landing/items/cursed-ashbringer.webp" alt="" fill sizes="600px" className="object-contain" />
        </ParallaxItem>
      </div>
