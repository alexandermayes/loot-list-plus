  ...
  return (
    <>
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-[#0a0b0e] border border-[rgba(255,255,255,0.1)] rounded-[40px] max-w-[817px] w-full px-[40px] lg:px-[60px] py-[40px] lg:py-[60px] relative"
                      ...
                      <div className="flex gap-[10px] items-stretch w-full">
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            setModalInviteCode(value.slice(0, 12))
                          }}
                          disabled={joining}
                        ...
                        <button
                          ...
                          disabled={!modalInviteCode.trim() || joining}
