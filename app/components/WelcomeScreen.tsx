  ...
  return (
    <>
      ...
      {showModal && (
        ...
        >
          <div
            className="bg-[#0a0b0e] border border-[rgba(255,255,255,0.1)] rounded-[40px] max-w-[600px] w-full px-[40px] lg:px-[60px] py-[40px] lg:py-[60px] relative"
            ...
            {modalView === 'main' ? (
              <div className="flex flex-col gap-[20px] items-center w-full">
                ...
                <div className="flex flex-col gap-[10px] items-center justify-center w-full text-center">
                  <svg className="w-[44px] h-[44px] mb-2" viewBox="0 0 71 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h2 className="font-poppins font-bold text-[32px] lg:text-[42px] leading-[43px] text-white">
                    Join via Discord
                  </h2>
                  <p className="font-poppins font-normal text-[14px] lg:text-[16px] leading-[normal] text-[#a1a1a1]">
                ...
                <button
                  ...
                  className="bg-[#5865f2] border border-[#383838] rounded-[52px] px-[20px] py-[12px] flex gap-[12px] items-center justify-center w-full hover:opacity-90 transition mt-4"
                >
                ...
                {/* Footer Info */}
                <div className="flex items-start gap-2 px-[20px] py-[16px] rounded-[12px] bg-[#0d0e11]/50 border border-[rgba(255,255,255,0.1)] w-full mt-2">
