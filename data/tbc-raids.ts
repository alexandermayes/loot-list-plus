...
export const blacktemple: Raid = {
  ...
  bosses: [
    ...
    },
    {
      ...
      items: [
        { name: 'Softstep Boots of Tracking', slot: 'Feet', wowhead_id: 32510 },
        { name: 'Insidious Bands', slot: 'Wrist', wowhead_id: 32324 },
        { name: 'Shadowmoon Destroyer\'s Drape', slot: 'Back', wowhead_id: 32323 },
        { name: 'Robe of the Shadow Council', slot: 'Chest', wowhead_id: 32327 },
        { name: 'Girdle of Lordaeron\'s Fallen', slot: 'Waist', wowhead_id: 32512 },
        { name: 'Girdle of the Lightbearer', slot: 'Waist', wowhead_id: 32606 },
        { name: 'Soul Cleaver', slot: 'Two-Hand', wowhead_id: 32348 },
  ...
  bosses: [
    {
      ...
      items: [
        ...
        { name: 'Band of Lucent Beams', slot: 'Finger', wowhead_id: 34166 },
    ...
    },
    {
      name: 'Eredar Twins',
      items: [
        { name: 'Shiv of Exsanguination', slot: 'One-Hand', wowhead_id: 34197 },
        { name: 'Crimson Paragon\'s Cover', slot: 'Head', wowhead_id: 34190 },
        { name: 'Sin\'dorei Pendant of Conquest', slot: 'Neck', wowhead_id: 35290 },
        { name: 'Sin\'dorei Pendant of Salvation', slot: 'Neck', wowhead_id: 35291 },
    ...
    },
    {
      name: 'M\'uru',
      items: [
        { name: 'Gauntlets of the Soothed Soul', slot: 'Hands', wowhead_id: 34240 },
        { name: 'Mounting Vengeance', slot: 'Waist', wowhead_id: 34346 },
        { name: 'Sin\'dorei Band of Dominance', slot: 'Finger', wowhead_id: 35282 },
        { name: 'Sin\'dorei Band of Salvation', slot: 'Finger', wowhead_id: 35283 },
        { name: 'Sin\'dorei Band of Triumph', slot: 'Finger', wowhead_id: 35284 },
        { name: 'Sunglow Vest', slot: 'Chest', wowhead_id: 34212 },
