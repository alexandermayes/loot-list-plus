...
export const TBC_BIS: BisExpansionData = {
  ...
  'Holy Paladin': {
    ...
    'Serpentshrine Cavern': {
      'Head': [{ wowhead_id: 30243, priority: 'bis' }],  // Helm of the Vanquished Champion (T5 token)
      'Neck': [{ wowhead_id: 30018, priority: 'bis' }],  // Lord Sanguinar's Claim
      'Shoulder': [{ wowhead_id: 30249, priority: 'bis' }],  // Pauldrons of the Vanquished Champion (T5 token)
      'Chest': [{ wowhead_id: 30237, priority: 'bis' }],  // Chestguard of the Vanquished Champion (T5 token)
      'Waist': [{ wowhead_id: 30038, priority: 'bis' }],  // Belt of One-Hundred Deaths
      'Legs': [{ wowhead_id: 30246, priority: 'bis' }],  // Leggings of the Vanquished Champion (T5 token)
      'Hands': [{ wowhead_id: 30240, priority: 'bis' }],  // Gloves of the Vanquished Champion (T5 token)
      'Trinket': [
  ...
  'Elemental Shaman': {
    ...
    'Serpentshrine Cavern': {
      ...
      'Shoulder': [
        { wowhead_id: 30249, priority: 'bis' },  // Pauldrons of the Vanquished Champion (T5 token)
        { wowhead_id: 29037, priority: 'alt' }   // Cyclone Shoulderguards (T4)
      ],
      'Back': [{ wowhead_id: 29992, priority: 'bis' }],  // Royal Cloak of the Sunstriders
      'Chest': [
        { wowhead_id: 30237, priority: 'bis' },  // Chestguard of the Vanquished Champion (T5 token)
  ...
  'Mage': {
    ...
    'Serpentshrine Cavern': {
      ...
      'Legs': [{ wowhead_id: 30247, priority: 'bis' }],  // Leggings of the Vanquished Hero (T5 token)
      'Feet': [
  ...
  'Rogue': {
    ...
    'Serpentshrine Cavern': {
      ...
      'Chest': [
        ...
        { wowhead_id: 30237, priority: 'alt' }   // Chestguard of the Vanquished Champion (T5 token)
      ],
      'Wrist': [{ wowhead_id: 29966, priority: 'bis' }],  // Vambraces of Ending
      'Hands': [{ wowhead_id: 30240, priority: 'bis' }],  // Gloves of the Vanquished Champion (T5 token)
      'Waist': [{ wowhead_id: 30106, priority: 'bis' }],  // Belt of One-Hundred Deaths
